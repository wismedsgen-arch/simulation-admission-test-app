...
import { formatDateTime, formatRelativeTime, formatTimeOnly, toDomDir, toTextAlign } from "@/lib/utils";
...
function TimelineView({ entries }: { entries: TimelineEntry[] }) {
  ...
  const gridTemplateColumns = "78px 70px 180px minmax(220px,1fr) 130px 40px";
  const rowMinWidth = 820;
